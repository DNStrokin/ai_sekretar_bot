...
async def _show_format_menu(message_or_obj, state: FSMContext, topic_id: int):
    ...
    async with session_maker() as session:
        ...
        text = (
            ...
            f"• <code>&lt;b&gt;...&lt;/b&gt;</code> → <b>жирный</b>\n"
            f"• <code>&lt;i&gt;...&lt;/i&gt;</code> → <i>курсив</i>\n"
            f"• <code>&lt;u&gt;...&lt;/u&gt;</code> → <u>подчеркнутый</u>\n"
            f"• <code>&lt;s&gt;...&lt;/s&gt;</code> → <s>зачеркнутый</s>\n"
            f"• <code>&lt;code&gt;...&lt;/code&gt;</code> → <code>код</code> (копируется при клике)\n"
            f"• <code>&lt;pre&gt;...&lt;/pre&gt;</code> → блок кода (копируется)\n"
            f"• <code>&lt;blockquote&gt;...&lt;/blockquote&gt;</code> → <blockquote>цитата</blockquote>\n"
            f"• <code>&lt;a href='URL'&gt;...&lt;/a&gt;</code> → <a href='https://t.me'>ссылка</a>\n\n"
